...
export const BottomNav = ({ currentPath }: BottomNavProps) => {
  ...
  return (
    <>
      ...
      <nav className="hidden lg:block fixed top-0 left-0 right-0 bg-card/95 backdrop-blur-lg border-b border-border z-50">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-2">
          <div className="flex items-center gap-1">
            <span className="text-lg font-bold text-primary mr-6">myCortes</span>
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "relative flex items-center gap-2 px-4 py-2.5 rounded-lg transition-all duration-200 text-sm font-medium",
                ...
                >
                  <div className="relative">
                    ...
                    {item.badge && (
                      <span className="absolute -top-1.5 -right-1.5 h-4 w-4 flex items-center justify-center bg-accent text-accent-foreground text-[10px] font-bold rounded-full">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-card/95 backdrop-blur-lg border-t border-border safe-area-pb z-50">
